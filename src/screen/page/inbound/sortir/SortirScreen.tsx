...
import { SortirParamList } from '../../../navigation/inbound/SortirNavigator.tsx';

type NavigationProp = StackNavigationProp<SortirParamList, 'SortirMain'>;
...
function ReturScreen() {
  ...
  const fetchRetur = async () => {
    try {
      setRefreshing(true);
      showLoadingDialog('Loading List Sortir Planning');
      ...
      hideLoadingDialog();
      showDialog('error', 'Error while Fetching Data Sortir!');
      setRefreshing(false);
    }
  };
            ...
            filteredList.map((item: any) => {
              ...
              return (
                <InboundCard
                  ...
                  onClick={() => navigation.navigate('SortirSku', { item })}
                />
              );
            })
          )}

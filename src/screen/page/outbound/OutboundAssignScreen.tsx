...
type FormOutboundRouteProp = RouteProp<OutboundParamList, 'OutboundAssign'>;
type FormActivityProps = {
  route: FormOutboundRouteProp;
};
type NavigationProp = StackNavigationProp<OutboundParamList, 'OutboundMain'>;
function OutboundAssignScreen( { route }: FormActivityProps ) {
...
export default OutboundAssignScreen;

...
import { SortirParamList } from '../../../navigation/inbound/SortirNavigator';

type SortirDetailRouteProp = RouteProp<SortirParamList, 'SortirSkuDetail'>;

export default function SortirSkuList() {
    const route = useRoute<SortirDetailRouteProp>();
    const navigation = useNavigation<StackNavigationProp<SortirParamList, 'SortirSkuDetail'>>();
                ...
                {dummyDataSKU.map((sku) => (
                    <View key={sku.id} style={styles.card}>
                        ...
                        <TouchableOpacity 
                            ...
                            onPress={() => navigation.navigate('SortirSkuDetail', { item: sku })}
                        >
                            <Text style={styles.actionButtonText}>Mulai Sorting</Text>
